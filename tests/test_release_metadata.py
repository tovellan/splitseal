...
def test_release_metadata_rejects_private_or_attributed_content() -> None:
    invalid_bodies = [
        ...
        "Reviewed-by: release reviewer",
        "Built for a " + "found" + "er audience",
        "Presented to " + "Y" + "C",
        "Apply " + "humani" + "zation wording",
        "Humani" + "ze the release notes",
        ...
        "See tovellan-" + "infra checkout",
        "See tovellan-" + "handbook worktree",
