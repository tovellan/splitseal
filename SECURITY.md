...
source archive. Closure verifies every distribution subject against the exact release
workflow, protected tag ref, workflow revision, and source commit. The attestation does not
replace source review, establish dataset quality, or act as an independent transparency
log.
