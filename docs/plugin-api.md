...
Entry-point discovery, loading, and interface failures return `SS060`. Failures from a
custom loader, analysis iteration, or version evidence return `SS061`. No release
