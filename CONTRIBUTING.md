...
Protected releases must use an existing version tag and the `Release assets` workflow.
Do not publish a release manually before its assets are attached: publication activates
release immutability and prevents later asset changes.
